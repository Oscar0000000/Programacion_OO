...
public class Main {
	...
	public static void main(String[] args) {
		...
		EventoMusical conciertoBisbal = new EventoMusical("Los Chunguitos", 
				new Date(2026, 11, 2), new BigDecimal (125000), GeneroMusical.POP);
		
		EventoMusical conciertoBadBunny = new EventoMusical("El Canelita", 
		...
		Artista chunguitos = new Artista();
		chunguitos.setNombre("Los Chunguitos");
		chunguitos.setPais("España");
		conciertochunguitos.agregarArtista(chunguitos);
		
		Artista canelita = new Artista();
		canelita.setNombre("El Canelita");
		canelita.setPais("España");
		conciertocanelita.agregarArtista(canelita);
		...
		//em.persist(conciertochunguitos);
